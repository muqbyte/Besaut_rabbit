        ...
        <View style={StyleSheet.container}>
            <View>
                <View style={styles.firstcontainer}>
                    <ParameterIndicator headerName="RB-01" rabbitLogo={rabbitLogo} temperature={informationRba.temperatureA} humidity={informationRba.humidityA} amonia={informationRba.amoniaA} />
                </View>
